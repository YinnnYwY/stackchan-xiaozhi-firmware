...
| 🎤 **唤醒词** | "你好小智"（Multinet6），灵敏度 Low / Medium / High 可调 |
| 👆 **头顶触摸** | 3 区电容触摸（SI12T），摸头触发对话，7 条随机回应 |
| 📱 **屏幕触摸** | 6 种手势（FT6336）—— 双击 / 滑动 / 长按，60 条动作文本 |
| 🕺 **体感检测** | 摇晃 + 抱起触发互动（BMI270），说话时自动屏蔽，5 分钟冷却 |
| 💡 **情绪灯环** | WS2812×12，21 种情绪颜色映射，PY32 IO Expander 控制 |
| 🎯 **舵机追踪** | SCS 总线舵机，GC0308 人脸追踪 + 空闲扫视，对话时暂停 |
| 😴 **智能休眠** | 30 秒空闲自动关灯 / 停舵机 / 熄屏，唤醒词恢复 |
| 🔌 **重新配网** | Idle 状态长按屏幕 5 秒进入配网模式（192.168.4.1） |
| ✂️ **文本打断** | 对话中可插入文本消息，不被静默丢弃 |
| 🔧 **MCP 工具** | LED / 音量 / 亮度 / 摄像头 / 系统信息远程控制 |
